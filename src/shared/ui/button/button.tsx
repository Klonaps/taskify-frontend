...
const variantToClassName: Record<ButtonStatus, string> = {
  primary:
    'bg-blue-600 disabled:bg-blue-300 hover:bg-blue-500 active:bg-blue-700 text-white',
  secondary: 'text-white',
  outline: 'border border-black hover:bg-black hover:text-white box-border',
}
